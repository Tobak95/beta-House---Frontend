      ...
      <div className="layout flex">
        <div className="mx-auto w-[482px]  lg:p-7">
          ...
          <form
            ...
            className="mt-5 p-4 lg:p-0"
          >
            <div className="lg:flex items-center :flex justify-between gap-2 lg:gap-6 lg:w-[218px] h-[81px]">
              <div className="flex  flex-col  justify-between">
                ...
                <input
                  ...
                  className="p-2 border border-[#DEDFE0] h-[54.3px] rounded-[5px] mt-1"
                  {...register("firstName")}
                />
              ...
              <div className="flex flex-col  mt-3 lg:mt-0">
                <label htmlFor="lastName " className="text-[16px] font-[500]">
                  Last name
                </label>
                <input
                  id="lastName"
                  type="text"
                  placeholder="Enter Name"
                  className="p-2 border border-[#DEDFE0] h-[54.3px] rounded-[5px] mt-"
                  {...register("lastName")}
                />
                <p className="text-red-500 text-sm ">
        ...
        <div className="hidden lg:block mt-17">
          <AuthWrapper />
        </div>
      </div>
    </div>
